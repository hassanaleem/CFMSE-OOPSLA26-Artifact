...
# rm -rf json.h/*.pdf json.h/*.png
# rm -rf libosip/*.pdf libosip/*.png libosip/killed_states.*
# rm -rf libyaml/*.pdf libyaml/*.png libyaml/killed_states.*
# rm -rf regex/*.pdf regex/*.png
# rm -rf utf8.h/*.pdf utf8.h/*.png
