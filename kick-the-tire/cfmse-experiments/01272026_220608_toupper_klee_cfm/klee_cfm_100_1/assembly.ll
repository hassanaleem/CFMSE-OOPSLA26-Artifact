...
entry:
  %conv = sext i32 100 to i64, !dbg !37, !sourceFile !12, !mergedLineNum !38
  ...
  %conv1 = sext i32 100 to i64, !dbg !41, !sourceFile !12, !mergedLineNum !42
  ...
  call void @to_upper(i8* %call, i32 100), !dbg !45, !sourceFile !12, !mergedLineNum !46
  %cfmse.dci_gep = getelementptr [8 x i8], [8 x i8]* @cfmse.dci_gv, i64 0, i64 0
