...
#define zLicenseDescrip (uudecode_opt_strs+292)
 ...
 */
static char const uudecode_opt_strs[4756] =
/*     0 */ "uudecode (GNU sharutils) 4.15\n"
            "Copyright (C) 1994-2015 Free Software Foundation, Inc., all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   292 */ "uudecode is free software: you can redistribute it and/or modify it under\n"
            ...
            "You should have received a copy of the GNU General Public License along\n"
            "with this program.  If not, see <http://www.gnu.org/licenses/>.\n\0"
/*   897 */ "direct output to file\0"
/*   919 */ "OUTPUT_FILE\0"
/*   931 */ "output-file\0"
/*   943 */ "ignore fchmod(3P) errors\0"
/*   968 */ "IGNORE_CHMOD\0"
/*   981 */ "ignore-chmod\0"
/*   994 */ "display extended usage information and exit\0"
/*  1038 */ "help\0"
/*  1043 */ "extended usage information passed thru pager\0"
/*  1088 */ "more-help\0"
/*  1098 */ "output version information and exit\0"
/*  1134 */ "version\0"
/*  1142 */ "save the option state to a config file\0"
/*  1181 */ "save-opts\0"
/*  1191 */ "load options from a config file\0"
/*  1223 */ "LOAD_OPTS\0"
/*  1233 */ "no-load-opts\0"
/*  1246 */ "no\0"
/*  1249 */ "UUDECODE\0"
/*  1258 */ "uudecode (GNU sharutils) - decode an encoded file\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [<file>...]\n\0"
/*  1378 */ "$HOME\0"
/*  1384 */ ".sharrc\0"
/*  1392 */ "bug-gnu-utils@gnu.org\0"
/*  1414 */ "If no 'file'(s) are provided, then standard input is decoded.\n\0"
/*  1477 */ "'uudecode' transforms uuencoded files into their original form.\n\n"
...
/*  2506 */ "uudecode (GNU sharutils) 4.15\0"
/*  2536 */ "uudecode (GNU sharutils) - decode an encoded file\n"
...
/*  4586 */ "uudecode (GNU sharutils) - decode an encoded file\n"
            "Usage:  uudecode [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [<file>...]\n"
...
#define OUTPUT_FILE_DESC      (uudecode_opt_strs+897)
/** Upper-cased name for the output-file option */
#define OUTPUT_FILE_NAME      (uudecode_opt_strs+919)
/** Name string for the output-file option */
#define OUTPUT_FILE_name      (uudecode_opt_strs+931)
...
#define IGNORE_CHMOD_DESC      (uudecode_opt_strs+943)
/** Upper-cased name for the ignore-chmod option */
#define IGNORE_CHMOD_NAME      (uudecode_opt_strs+968)
/** Name string for the ignore-chmod option */
#define IGNORE_CHMOD_name      (uudecode_opt_strs+981)
 ...
 */
#define HELP_DESC       (uudecode_opt_strs+994)
#define HELP_name       (uudecode_opt_strs+1038)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (uudecode_opt_strs+1043)
#define MORE_HELP_name  (uudecode_opt_strs+1088)
...
#endif
#define VER_DESC        (uudecode_opt_strs+1098)
#define VER_name        (uudecode_opt_strs+1134)
#define SAVE_OPTS_DESC  (uudecode_opt_strs+1142)
#define SAVE_OPTS_name  (uudecode_opt_strs+1181)
#define LOAD_OPTS_DESC     (uudecode_opt_strs+1191)
#define LOAD_OPTS_NAME     (uudecode_opt_strs+1223)
#define NO_LOAD_OPTS_name  (uudecode_opt_strs+1233)
#define LOAD_OPTS_pfx      (uudecode_opt_strs+1246)
...
#define uudecode_full_usage (uudecode_opt_strs+2536)
#define uudecode_short_usage (uudecode_opt_strs+4586)
...
static void bogus_function(void) {
  ...
  puts(_("uudecode (GNU sharutils) 4.15\n\
Copyright (C) 1994-2015 Free Software Foundation, Inc., all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the GNU General Public License,\n\
version 3 or later <http://gnu.org/licenses/gpl.html>\n"));
