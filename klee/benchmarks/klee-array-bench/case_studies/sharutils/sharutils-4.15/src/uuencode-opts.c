...
#define zLicenseDescrip (uuencode_opt_strs+292)
 ...
 */
static char const uuencode_opt_strs[4265] =
/*     0 */ "uuencode (GNU sharutils) 4.15\n"
            "Copyright (C) 1994-2015 Free Software Foundation, Inc., all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   292 */ "uuencode is free software: you can redistribute it and/or modify it under\n"
            ...
            "You should have received a copy of the GNU General Public License along\n"
            "with this program.  If not, see <http://www.gnu.org/licenses/>.\n\0"
/*   897 */ "convert using base64\0"
/*   918 */ "BASE64\0"
/*   925 */ "base64\0"
/*   932 */ "encode the output file name\0"
/*   960 */ "ENCODE_FILE_NAME\0"
/*   977 */ "encode-file-name\0"
...
/*  1246 */ "no\0"
/*  1249 */ "UUENCODE\0"
/*  1258 */ "uuencode (GNU sharutils) - encode a file into email friendly text\n"
            "Usage:  %s [ -<flag> | --<name> ]... [<in-file>] <output-name>\n\0"
/*  1388 */ "$HOME\0"
/*  1394 */ ".sharrc\0"
/*  1402 */ "bug-gnu-utils@gnu.org\0"
/*  1424 */ "'uuencode' is used to create an ASCII representation of a file that can be\n"
...
/*  2254 */ "uuencode (GNU sharutils) 4.15\0"
/*  2284 */ "uuencode (GNU sharutils) - encode a file into email friendly text\n"
...
/*  4085 */ "uuencode (GNU sharutils) - encode a file into email friendly text\n"
            "Usage:  uuencode [ -<flag> | --<name> ]... [<in-file>] <output-name>\n"
...
#define BASE64_DESC      (uuencode_opt_strs+897)
/** Upper-cased name for the base64 option */
#define BASE64_NAME      (uuencode_opt_strs+918)
...
#define ENCODE_FILE_NAME_DESC      (uuencode_opt_strs+932)
/** Upper-cased name for the encode-file-name option */
#define ENCODE_FILE_NAME_NAME      (uuencode_opt_strs+960)
/** Name string for the encode-file-name option */
#define ENCODE_FILE_NAME_name      (uuencode_opt_strs+977)
 ...
 */
#define HELP_DESC       (uuencode_opt_strs+994)
#define HELP_name       (uuencode_opt_strs+1038)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (uuencode_opt_strs+1043)
#define MORE_HELP_name  (uuencode_opt_strs+1088)
...
#endif
#define VER_DESC        (uuencode_opt_strs+1098)
#define VER_name        (uuencode_opt_strs+1134)
#define SAVE_OPTS_DESC  (uuencode_opt_strs+1142)
#define SAVE_OPTS_name  (uuencode_opt_strs+1181)
#define LOAD_OPTS_DESC     (uuencode_opt_strs+1191)
#define LOAD_OPTS_NAME     (uuencode_opt_strs+1223)
#define NO_LOAD_OPTS_name  (uuencode_opt_strs+1233)
#define LOAD_OPTS_pfx      (uuencode_opt_strs+1246)
...
#define uuencode_full_usage (uuencode_opt_strs+2284)
#define uuencode_short_usage (uuencode_opt_strs+4085)
...
static void bogus_function(void) {
  ...
  puts(_("uuencode (GNU sharutils) 4.15\n\
Copyright (C) 1994-2015 Free Software Foundation, Inc., all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the GNU General Public License,\n\
version 3 or later <http://gnu.org/licenses/gpl.html>\n"));
