...
void initializeCFMSE(PassRegistry&);
void initializeCFMSELocationAnalysis(PassRegistry&);
void initializeBBReplication(PassRegistry&);
...
void initializeCFMSELegacyPassPass(PassRegistry &Registry);
void initializeCFMSELocationAnalysisLegacyPassPass(PassRegistry &Registry);
void initializeBBReplicationLegacyPassPass(PassRegistry &Registry);
