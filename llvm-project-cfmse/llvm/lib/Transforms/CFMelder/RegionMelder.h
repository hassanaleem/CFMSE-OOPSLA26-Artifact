...
private:
  ...
  // insert dead code to avoid additional branches (predication)
  bool InsertDeadCode = false;

public:
  RegionMelder(RegionAnalyzer &MA, bool InsertDeadCode = false)
      : MA(MA), InsertDeadCode(InsertDeadCode) {}
