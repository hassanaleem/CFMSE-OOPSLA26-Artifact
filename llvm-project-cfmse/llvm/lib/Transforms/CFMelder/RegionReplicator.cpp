...
void RegionReplicator::concretizeBranchConditions(BasicBlock *ExpandedBlock,
  ...
  // RAUW phase : for each broken user we find the corresponding defining PHI
  // node in the region exit. this PHI node must have non-undef value for the
  // incoming path selected in concretizeBranchCinditions
